/**
 * Build the cc-aligned tool list.
 *
 * Assembles every cc tool permitted by the host's allow/deny config,
...
export interface BuildToolsResult {
  ...
  /** All tool names — cc + user — that the agent will see. */
  allToolNames: string[]
}
