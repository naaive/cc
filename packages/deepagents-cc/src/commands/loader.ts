/**
 * Custom commands loader — Anthropic Claude Code's `.claude/commands/`
 * convention.
 *
 ...
 * Layout:
 *
 *   <repo>/.claude/commands/lint.md          → /lint
 *   <repo>/.claude/commands/git/commit.md    → /git:commit  (folder = namespace)
 *   ~/.claude/commands/init.md               → /init        (user-level)
 *
