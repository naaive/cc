 ...
 * Error-retry guard.
 *
 * cc observes that models often retry the *same* tool call after seeing the
 ...
 * stop and ask the user. cc has the same circuit breaker.
 */
  ...
  return createMiddleware({
    ...
    wrapToolCall: async (
      request: {
        ...
        state: {
          toolErrors?: Array<{ fingerprint: string; errorText: string; at: number }>
