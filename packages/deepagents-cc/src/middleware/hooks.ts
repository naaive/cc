/**
 * Hooks middleware — cc's PreToolUse / PostToolUse / UserPromptSubmit /
 * SessionStart event surface.
 *
 * In cc the harness runs configured shell commands at well-known points so
...
export function createHooksMiddleware(
  ...
  return createMiddleware({
    ...
    wrapToolCall: async (
      request: { toolCall: { name: string; id: string; args: unknown } },
