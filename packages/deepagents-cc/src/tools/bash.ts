/**
 * Bash, BashOutput, KillShell — cc-aligned names + persistent shell + bg jobs.
 *
...
export interface BashToolBundle {
  bash: ReturnType<typeof tool>
  bashOutput: ReturnType<typeof tool>
  killShell: ReturnType<typeof tool>
