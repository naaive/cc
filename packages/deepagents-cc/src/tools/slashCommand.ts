 ...
 *
 * Custom commands live in `.claude/commands/<name>.md` (and `~/.claude/...`).
...
const description = `Invoke a user-defined custom command from .claude/commands/.
...
const discoverDescription = `List user-defined custom commands installed in .claude/commands/.
